...
public class GanJiTest {
    ...
    private volatile static ProxyUtil proxyUtil = new ProxyUtil();
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("总共ip：" + proxyUtil.proxyEntities.size());
    ...
    private static Elements getCityInfo(String url, int retryCount) {
        try {
            ...
            Document document = Jsoup.connect(url)
                    ...
                    .header("x-forward-for", inetSocketAddress.getHostName())
                    .header("client_ip", inetSocketAddress.getHostName())
                    .execute().parse();
